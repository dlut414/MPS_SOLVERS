...
public:
    ...
    void allocGeo();                                     //create geometry of the case
    void allocCell();                                    //allocate memory for cells
    void allocMatrix();                                  //allocate memory for matrixA
...
protected:
    ...
    /*---------------------------*/
    /*-----matrix-----*/
    matrix_COO<integer, real>* matrixA;
    /*----------------*/
