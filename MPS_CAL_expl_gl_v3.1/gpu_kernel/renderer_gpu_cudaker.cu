...
*/
                     ...
                     const uint* const dev_u_triTable )
    {
        ...
        ///call routines
        kerCalTriangle<<<(i_nVoxel+BLOCK_DIM_X_L-1)/BLOCK_DIM_X_L, BLOCK_DIM_X_L, sizeof(mytype::real3)*12*BLOCK_DIM_X_L>>>
                                                                              ( dev_r3_triangle,
                                                                                dev_r_alpha,
                                                                                dev_r3_verList,
                                                                                dev_r_vertex_n,
        ...
        ///call routines
        kerCalTriangle<<<(i_nVoxel+BLOCK_DIM_X_L-1)/BLOCK_DIM_X_L, BLOCK_DIM_X_L>>>
                                                                              ( dev_r3_triangle,
                                                                                dev_r_alpha,
                                                                                dev_r3_verList,
                                                                                dev_r_vertex_n,
...
*/
                    ...
                    const uint* const dev_u_triTable )
    {
        ...
        ///call routines
        kerCalNorm_2<<<(i_nVoxel+BLOCK_DIM_X_L-1)/BLOCK_DIM_X_L, BLOCK_DIM_X_L, sizeof(mytype::real3)*12*BLOCK_DIM_X_L>>>
                                                                              ( dev_r3_norm,
                                                                                dev_r3_triangle,
                                                                                dev_r3_verList,
                                                                                dev_r3_vertex_norm,
        ...
        ///call routines
        kerCalNorm_2<<<(i_nVoxel+BLOCK_DIM_X_L-1)/BLOCK_DIM_X_L, BLOCK_DIM_X_L>>>
                                                                              ( dev_r3_norm,
                                                                                dev_r3_triangle,
                                                                                dev_r3_verList,
                                                                                dev_r3_vertex_norm,
