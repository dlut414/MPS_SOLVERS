...
protected:
    ...
    void calNorm     ();        //calculate normals on vertices
...
protected:
    ...
    /*-----new-----*/
    integer* dev_i_markVox;  //voxeles in which surface may exist
    //integer* dev_i_cellToVox;
    integer* dev_i_voxToCell;
    integer* dev_i_cellInFluid;
    /*-------------*/
...
public:
    ...
    /*-----new-----*/
    std::vector<integer> i_markVox;
    std::vector<integer> i_markCell;
    std::vector<integer> i_cellToVox;   //mapping cell id to vox id
    std::vector<integer> i_voxToCell;
    /*-------------*/
    /*------------------------------*/
/*
void WriteCase()
