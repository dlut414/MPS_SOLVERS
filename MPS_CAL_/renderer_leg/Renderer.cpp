...
void Renderer::myInit(int argc, char** argv)
{
    ...
    programID1 = myLoadShader("./shader3/vertex.glsl", "./shader3/fragment.glsl");
    programID2 = myLoadShader("./shader2/vertex.glsl", "./shader2/fragment.glsl");
