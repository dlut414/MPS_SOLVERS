...
MPS::~MPS()
{
    ...
    delete[] i_bd_in_cell;      i_bd_in_cell = NULL;
    delete[] i_cellInFluid;     i_cellInFluid = NULL;
...
void MPS::allocateCellList()
{
    ...
    geo.d_cell_front    += 2*d_max_dis; //note: too close to fluid surface
    ...
    i_bd_in_cell    = new integer[geo.i_num_cells];
    i_cellInFluid   = new integer[geo.i_num_cells];
    i_cell_start    = new integer[geo.i_num_cells];
    i_cell_end      = new integer[geo.i_num_cells];
