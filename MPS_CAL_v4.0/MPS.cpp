...
{
    char str[256];
    integer _neighbor; //for i_link_cell
    FILE* _fid_log;
    ...
    i_link_cell = new integer*[i_num_cells];
    for(integer i=0;i<i_num_cells;i++) i_link_cell[i] = new integer[_neighbor + 1];
    ...
    memAdd(sizeof(integer), i_num_cells * i_num_cells);
