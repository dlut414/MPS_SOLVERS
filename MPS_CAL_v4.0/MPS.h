...
protected:
    ...
    integer* i_type;//type of each particle: from outside to inside 2, 1, 0
    ...
    integer i_cell_dx, i_cell_dy, i_cell_dz;//# of cells in each dim, cal before the first step
