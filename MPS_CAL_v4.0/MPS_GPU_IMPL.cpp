...
*/
//MPS_GPU_IMPL.cpp
//implementation of class MPS_GPU_IMPL
...
///update pos and vel
//////////////////////////////
template<unsigned int _dir> void MPS_GPU_IMPL::updatePosVel()
{
    switch(_dir)
    {
        case 1:
...
//////////////////////////////
template<unsigned int _dir> void MPS_GPU_IMPL::buildCG_CN()
{
...
//////////////////////////////
void MPS_GPU_IMPL::visCrankNicolson()
{
    //x direction
    buildCG_CN<1>();
    DoCG(i_np);
